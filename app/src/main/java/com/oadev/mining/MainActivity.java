...
public class MainActivity extends AppCompatActivity {
        ...
        if (countdownTime > 0) {
            ...
            new CountDownTimer(countdownTime, 1000) {
                public void onTick(long millisUntilFinished) {
                    ...
                    amount += ninfactor;
                    fragmentHome.getAvailableCoinView().setText(String.valueOf(amount));
    ...
    public void setCountdownTime() {
        ...
        if (timediff < 0) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, Config.functionUrl + "method=" + "updatetime" + "&userid=" + user.getId(),
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            progressBar.setVisibility(View.GONE);
    ...
    private void addhistory(String tittle,String status) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config.functionUrl + "method=" + "addhistory" + "&userid=" + user.getId() + "&tittle=" + tittle + "&status" + status,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressBar.setVisibility(View.GONE);
